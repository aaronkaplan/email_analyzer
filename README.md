...
3. optionally submit the batch and download results
...
## TL;DR Configure OpenAI

If you want to use `submit-batch`, create a local `.env` file from the checked-in example:
...
If you want to submit the batch and export the results to Excel:
...
4. `batch-output-to-xlsx`: convert successful structured batch results into `.xlsx`
